            ...
            <div class="card-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                  // print_r($_GET);
                    $qulog="SELECT * FROM distributor where showing = '0'";
                    // echo "$qulog";
                  ...
                  <tr>
                    ...
                    <td class="align-middle line-clamp-4"><?php echo $row['description'];?></td>
  ...
  <div class="modal-dialog modal-lg">
      <div class="modal-content" style=";color: #000;">
        <div class="modal-header justify-content-between" style="border-bottom: 0px solid !important;">
          <h3 class=""><span id="stat_title"></span> Distributor</h3>
            ...
            <form role="form" enctype="multipart/form-data" method="post" action="#">
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    <label>Phone</label>
                    <input type="text" class="form-control" name="title" id="edit_phone" placeholder="Masukkan Judul Karir ...">
                  </div>
                </div>
                <div class="col-sm-6">
                  <!-- text input -->
                  <div class="form-group">
                    <label>Email</label>
                    <input type="text" class="form-control" name="title" id="edit_email" placeholder="Masukkan Judul Karir ...">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
  ...
  function cr(stat, id){
    ...
    if(stat == "edit"){
      $.ajax({
  				type: "GET",
  				dataType: "json",
  				url: "mod/GetData.php?mod=distributor&id="+id, //Relative or absolute path to response.php?mod=mt file
  				// data: data,
            ...
            if(data.status == "01"){
              ...
              document.getElementById('edit_phone').value = data.msg['phone'];
              document.getElementById('edit_email').value = data.msg['email'];
  ...
  function subm(){
    ...
    if(stat == "edit"){
      ...
      $.ajax({
  				type: "POST",
  				dataType: "json",
  				url: "mod/UpdateData.php?mod=distributor", //Relative or absolute path to response.php?mod=mt file
  				data: data,
  				success: function(data){
            // alert(data.status);
            if(data.status == "01"){

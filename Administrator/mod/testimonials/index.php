          ...
          <div class="card">
            ...
            <div class="card-body">
              <button type="button" class="btn btn-primary mb-3" data-toggle="modal" data-target="#addModal" onclick="cr('new', '0')">
                <i class="fas fa-plus"> Add New Testimonial!</i>
              </button>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center align-middle">
                      ...
                      <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#mi-modal" onclick="setConf('<?php echo $row['id'];?>','<?php echo $row['name'];?>')">
        ...
        <div class="modal-header justify-content-center" style="border-bottom: 0px solid !important;">
          ...
          <div class=" justify-content-center text-center">
            ...
            <h5 class="color-base1 pt-3" style="width: 100%;"><strong><div id="title"></div></strong></h5>
              ...
              <div id="name"></div>
              <div id="position" class="mb-2"></div>
  ...
  <div class="modal-dialog modal-lg">
      <div class="modal-content" style=";color: #000;">
        <div class="modal-header justify-content-between" style="border-bottom: 0px solid !important;">
          <h3 class=""><span id="stat_title"></span> Testimonial</h3>
              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    <label>Name</label>
                    <input type="text" class="form-control" name="name" id="edit_name" placeholder="Masukkan Nama Pegawai ...">
                  </div>
                </div>
                <div class="col-sm-6">
                  <!-- text input -->
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="position" id="edit_position" placeholder="Masukkan Posisi Pegawai ...">
                  </div>
                </div>
                <div class="col-sm-6">
                  <!-- text input -->
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="sub_position" id="edit_sub_position" placeholder="Masukkan Sub Posisi Pegawai ...">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Yakin Menghapus Testimonial dengan Nama <span id="del_conf"></span> ?</h4>
      </div>
...
<script>
  ...
  function pass(id){
    ...
    $.ajax({
				type: "GET",
				dataType: "json",
				url: "mod/GetData.php?mod=testimonials&id="+id, //Relative or absolute path to response.php?mod=testimonials file
				// data: data,
          ...
          if(data.status == "01"){
            ...
            document.getElementById('name').innerHTML = data.msg['name'];
    ...
    if(stat == "edit"){
      $.ajax({
            ...
            if(data.status == "01"){
              ...
              document.getElementById('edit_name').value = data.msg['name'];
              document.getElementById('edit_position').value = data.msg['position'];
              document.getElementById('edit_sub_position').value = data.msg['position'];
      ...
      document.getElementById('edit_sub_position').value = '';
  ...
  function subm(){
    ...
    if(stat == "edit"){
      var data = {
        ...
        'sub_position': $('#edit_sub_position').val(),
      ...
      $.ajax({
  				type: "POST",
  				dataType: "json",
  				url: "mod/UpdateData.php?mod=testimonials", //Relative or absolute path to response.php?mod=testimonials file
  				data: data,
  				success: function(data){
            // alert(data.status);
            if(data.status == "01"){
      ...
      $.ajax({
  				type: "POST",
  				dataType: "json",
  				url: "mod/InsertData.php?mod=testimonials", //Relative or absolute path to response.php?mod=testimonials file
  				data: data,
  				success: function(data){
            // alert(data.status);
            if(data.status == "01"){
...
modalConfirm(function(confirm){
  if(confirm){
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "mod/UpdateData.php?mod=testimonials&id="+id, //Relative or absolute path to response.php?mod=testimonials file
        data: data,
        success: function(data){
          // alert(data.status);
          if(data.status == "01"){
